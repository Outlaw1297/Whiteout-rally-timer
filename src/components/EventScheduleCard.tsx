    ...
    <article className="p-4 bg-rally-surface border border-rally-border rounded-lg">
      <div className="flex justify-between items-start mb-3">
        <div>
          ...
          <p className="text-rally-muted text-xs mt-0.5">{event.status}</p>
        </div>
        <Link
      ...
      <div className="grid grid-cols-2 gap-2 text-sm mb-4">
        <div>
          ...
          <p className="font-mono font-bold">{formatArrivalTime(event.targetArrivalTime)}</p>
        </div>
        <div>
