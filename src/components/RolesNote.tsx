export function RolesNote({ compact = false }: { compact?: boolean }) {
  if (compact) {
    return (
      <p className="text-rally-muted text-xs">
        <strong className="text-rally-text">Admins and developers can be rally callers too</strong>{" "}
  ...
  return (
    <section className="p-3 mb-4 bg-rally-accent/10 border border-rally-accent/30 rounded-lg text-sm">
      ...
      <p className="text-rally-muted text-xs">
        <strong className="text-rally-text">Developer</strong> accounts can do everything admins
